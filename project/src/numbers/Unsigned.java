 ...
 * Час виконання: 15:32
 *
 * Клас {@code Unsigned} представляє беззнакове ціле число типу long.
 * Значення завжди повинно бути невід’ємним. Підтримує базові арифметичні
 * операції, перетворення у формат {@code double}, читання і запис у файл,
 * а також парсинг зі строкового представлення.
 *
