 ...
 * Час виконання: 12:42
 *
 * Клас {@code BigUnsigned} представляє беззнакове число довільної довжини
 * на основі {@code BigInteger}. Усі значення зберігаються у невід’ємному вигляді.
 * Клас підтримує арифметичні операції, перетворення у формат {@code double},
 * запис і читання з файлу, а також парсинг зі строкового представлення.
 *
